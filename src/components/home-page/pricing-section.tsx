      ...
      <section id="pricing" className="py-20 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-4">
          ...
          <motion.div
            ...
            className="bg-green-100 dark:bg-green-900 border border-green-300 dark:border-green-700 text-green-800 dark:text-green-100 px-6 py-4 rounded-xl shadow mb-10 text-center max-w-4xl mx-auto"
          >
            <strong className="font-semibold">🎉 Limited-Time Offer:</strong>
            <span className="ml-1">All features are <span className="font-bold">100% FREE</span> until <span className="underline underline-offset-2">30th July 2025</span> — no credit card needed!</span>
          </motion.div>
